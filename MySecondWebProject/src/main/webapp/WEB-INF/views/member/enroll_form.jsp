...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="sign-up" name="signup" id="signUpForm" method="post" style="margin-bottom: 0;">
			<table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
				...
				<tr>
					<td>
						<input type="text" name="memberId" id="user_id"
				...
				<tr>
					<td>
						<input type="password" id="password_check" name="pw_check" 
						class="form-control tooltipstered"  size="17" maxlength="20" 
						required="required" aria-required="true"						
