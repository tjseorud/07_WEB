...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="수정매핑" name="signup" id="signUpForm" method="post" style="margin-bottom: 0;">
			<table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
				...
				<tr>
					<td><input type="text" name="userId" id="user_id"
						...
						value="${ sessionScope.loginMember.memberId }" readonly><!-- sessionScope 작성을 권장 -->
					</td>
				</tr>
				<tr>
					<td style="text-align: left">
				...
				<tr>
					<td><input type="text" name="" id="user_name"
						...
						required="required" aria-required="true"						
						placeholder="한글로 최대 6자" value="${ sessionScope.loginMember.memberName }">
					</td>
				</tr>
				...
				<tr>
					<td><input type="email" name="" id="user_email"
						...
						required="required" aria-required="true"						
						placeholder="ex) kh@kh.com" value="${ sessionScope.loginMember.email }">
					</td>
				</tr>
