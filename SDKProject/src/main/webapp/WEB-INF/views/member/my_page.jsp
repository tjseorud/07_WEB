...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="my-page" name="signup" id="signUpForm" method="post" style="margin-bottom: 0;">
			<table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
				...
				<tr>
					<td><input type="text" name="userId" id="user_id"
						...
						value="${ sessionScope.loginUser.userId }" readonly><!-- sessionScope 작성을 권장 -->
					</td>
				</tr>
				<tr>
					<td style="text-align: left">
				...
				<tr>
					<td><input type="text" name="userName" id="user_name"
						...
						required="required" aria-required="true"						
						placeholder="한글로 최대 6자" value="${ sessionScope.loginUser.userName }">
					</td>
				</tr>
				...
				<tr>
					<td style="width: 100%; text-align: center; colspan: 2;">
						<input type="submit" value="정보수정" id="signup-btn"
						class="btn form-control tooltipstered" 
						style="background-color: #52b1ff;">
					</td>
				</tr>
				<tr>
					<td style="width: 100%; text-align: center; colspan: 2;">
						<input type="button" value="비밀번호수정" id="signup-btn"
						class="btn form-control tooltipstered" 
						style="background-color: #52ffe9;"
						data-toggle="modal" data-target="#updatePwd">
					</td>
				</tr>
				<tr>
					<td style="width: 100%; text-align: center; colspan: 2;">
						<input type="button" value="회원탈퇴" id="signup-btn"
						class="btn form-control tooltipstered" 
						style="background-color: #ff5352;"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="delete" method="post">
						...
						<button type="submit" class="btn btn-danger" onclick="return deleteUser();">회원탈퇴</button>
